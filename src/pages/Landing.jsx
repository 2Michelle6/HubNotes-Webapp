...
export default function Landing() {
  ...
  const showAuth = (signUp) => {
    setIsSignUp(signUp);
    document
      .querySelector("#account-access")
      ?.scrollInto({ behavior: "smooth", block: "center" });
  };
      ...
      <main className="landing-hero-grid">
        <section className="sign-in-card" aria-labelledby="hero-title">
          <p className="eyebrow-badge">
            <Sparkles size={15} /> Gamified active-recall study
          </p>
          <h2 id="hero-title" className="hero-title">
            Compile notes. Level up your study.
          </h2>
          <p className="hero-description">
            HubNotes brings active recall to life. Combine course material,
            PDFs, and custom flashcard decks into playable mini-games.
          </p>
        ...
        >
          <div className="auth-header">
            <h2 id="auth-title">
              {isSignUp ? "Join HubNotes" : "Welcome back"}
            </h2>
            <p>
              {isSignUp
                ? "Create your profile to sync your progress."
          ...
          <form className="auth-form" onSubmit={handleAuthenticationSubmit}>
            ...
            <button type="submit" className="btn-brutal btn-primary btn-full">
          ...
          <button
            type="button"
            className="btn-brutal btn-secondary btn-full"
            onClick={goToHome}
          >
